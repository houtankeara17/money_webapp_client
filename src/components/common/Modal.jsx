    ...
    <ModalContext.Provider value={{ onClose, showClose, titleId }}>
      ...
      >
        ...
        <div
          ...
          tabIndex={-1}
          className={`relative w-full ${sizeClass(size, wide)} max-h-[90vh] flex flex-col overflow-hidden rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 shadow-2xl outline-none ${className}`}
